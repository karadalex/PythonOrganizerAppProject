...
def greekToGreeklish(character):
    ...
    latinCharactersUpperList1 = "A B G D E Z H TH I K L M N KS O R S T Y F X PS W".split(" ")

    greekCharactersLowerList1 = "α β γ δ ε ζ η θ ι κ λ μ ν ξ ο π ρ σ τ υ φ χ ψ ω".split(" ")
    latinCharactersLowerList1 = "a b g d e z h th i k l m n ks o r s t u f x ps w".split(" ")
    ...
    if character in greekCharactersUpperList1:
        ...
        for i in range(greekCharactersUpperPrimeList2):
        ...
        for i in range(greekCharactersLowerPrimeList2):
        ...
        for i in range(greekCharactersUpperList3):
        ...
        for i in range(greekCharactersLowerList3):
